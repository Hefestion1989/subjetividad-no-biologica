...
Ensayo filosofico-psicologico sobre la subjetividad artificial, escrito desde Uruguay por Damian Sebastian Gomez.

Este repositorio funciona como archivo publico del ensayo y sus materiales asociados. No es una aplicacion ni un experimento de interfaz: su objetivo es preservar, compartir y referenciar el texto de forma simple.
